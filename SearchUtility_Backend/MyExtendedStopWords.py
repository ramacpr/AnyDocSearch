# -*- coding: utf-8 -*-
"""
Created on Sun Jun 23 15:11:06 2019
...
class ExtendedStopWord:
    _AllStopWords = set(StopWords.words('english'));
    _NewStopWords = ["a", "about", "above", "above", "across", "after", "afterwards", "again", "against",
                     ...
                     "better", "between",
                     "beyond", "both", "brief", "but", "by", "c’mon", "c’s", "came", "can", "can’t", "cannot", "cant",
                     ...
                     "did", "didn’t", "different", "do", "does", "doesn’t", "doing", "don’t", "done", "down",
                     "downwards", "during", "each", "edu",
                     ...
                     "you’re", "you’ve", "your", "yours", "yourself", "yourselves", "zero", "semi", "©", "š",
                     "1999", "2001", "www", "//", "/", "=", "**"];
